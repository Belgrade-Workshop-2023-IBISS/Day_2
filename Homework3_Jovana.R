...
gene.sets <- getGeneSets(library = "C5", gene.sets= c("GOMF_CYTOKINE_BINDING", "GOMF_CYTOKINE_RECEPTOR_ACTIVITY", "GOMF_CYTOKINE_RECEPTOR_BINDING", "GOMF_CYTOKINE_ACTIVITY"))
gene.sets                         
...
ridgeEnrichment(ES2, gene.set = "GOMF_CYTOKINE_BINDING", add.rug = TRUE)
ridgeEnrichment(ES2, gene.set = "GOMF_CYTOKINE_RECEPTOR_ACTIVITY", add.rug = TRUE)
ridgeEnrichment(ES2, gene.set = "GOMF_CYTOKINE_RECEPTOR_BINDING", add.rug = TRUE)
ridgeEnrichment(ES2, gene.set = "GOMF_CYTOKINE_ACTIVITY", add.rug = TRUE)
ridgeEnrichment(ES2, gene.set = "GOMF_CYTOKINE_BINDING", group = "cluster", add.rug = TRUE)
